...
;;; 
	.zilog
	.basic
scaddy = $1800		; address of screen in vram
spattr = $1b00		; address of sprite attributes in vram
sppatt = $3800		; address of sprite patterns in vram
vdpdat = $98		; vdp data read/write port
vdpsel = $99		; vdp register/address select port
;;; 
diamond = $83		; value of diamond character
maxx = 248		; maximum x coordinate
maxy = 184		; maximum y coordinate
numpat = 1		; number of sprite patterns
spcnt = 9		; number of sprites
;;;
	.org $a000
